...
<div align="center">
    <div id="images">
        <p style="text-align:center;">
        <a href="https://pabloagn.com/tools/">
...
<table>
  ...
  <tr>
    <td><b>Spark</b> (Scala/Python), <b>Kafka</b>, Flink, <b>Airflow</b>/Dagster, Databricks, dbt, Glassflow</td>
    <td>Lakehouse (Delta/Iceberg), Vector DBs (Qdrant, etc.), <b>Cloud</b> (AWS/Azure/GCP), IaC (<b>NixOS</b>, Terraform)</td>
    <td><b>Docker</b>, Kubernetes, Kubeflow, CI/CD for ML, GitOps, Observability, FastAPI</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>PostgreSQL, MySQL, MongoDB, Redis, DuckDB, ClickHouse</td>
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Flux** <br/> [![Repo](https://img.shields.io/badge/Repo-GitHub-grey?style=flat-square&logo=github)](https://github.com/pabloagn/flux) ![Status](https://img.shields.io/badge/Status-Active-38b2ac?style=flat-square)                                                                                                                           | An open source, declarative digital twin engine for electrochemical processes, written in Rust & prototyped in Python.                                                                                                                                                                                                                                                                                            | **Rust**, **Python**, **Apache Kafka**, **GlassFlow**, **ClickHouse**, **Docker**, **Nix**, **Pydantic**, **JAX**, Optax, Flax, **Scikit-learn**, **SciPy**, **PyMC**, **Polars**, **Ray**, **Temporal**, Prometheus, Grafana, Loki, OpenTelemetry, Alertmanager |
...
| **Rhodium** <br/> [![Repo](https://img.shields.io/badge/Repo-GitHub-grey?style=flat-square&logo=github)](https://github.com/pabloagn/rhodium) ![Status](https://img.shields.io/badge/Status-Active-38b2ac?style=flat-square)                                                                                                                     | **Modular, reproducible** NixOS configuration using **Flakes** and **Home Manager**, providing a **script-deployable** dev environment demonstrating **IaC practices**.                                                                                                                                                                                                                                           | **NixOS**, **Nix Flakes**, **Home Manager**, Shell Scripting, SOPS, CI/CD, Docker, Terraform, Argo CD                                                                                                                                                            |
